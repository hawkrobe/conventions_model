...
```{r}
simplicityPriorTrajectoriesPath <- 'simulations/P3/output/simplicity_trajectories.csv'
sharpPriorTrajectoriesPath <- 'simulations/P3/output/sharpPriorTrajectories.csv'
trajectories <- read_csv(here(simplicityPriorTrajectoriesPath)) %>%
  filter(time < 24) %>%
...
ggsave('../writing/journal_manuscript/figures/Exp2_model_partitionPrior.pdf',
...
ggsave('../writing/journal_manuscript/figures/Exp2_numWords_partitionPrior.pdf',
