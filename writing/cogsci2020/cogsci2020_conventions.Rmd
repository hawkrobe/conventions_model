...
Second, they are more robust to deviations than complete-pooling models relying on a fixed set of memory slots or a single mental dictionary. 
...
For future work using hierachical Bayesian models to address the full scale of an individual's  network of community, additional social knowledge about these communities must be learned and represented in the generative model [e.g. @gershman_learning_2017]. 
