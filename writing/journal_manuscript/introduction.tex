...
The tension between these two basic observations  --- stability and flexibility --- has posed a challenging and persistent puzzle for theories of convention.
Many influential computational accounts explaining how social conventions emerge in populations  do not allow for partner-specific meaning at all \cite<e.g.>{hurford1989biological,barr_establishing_2004,skyrms2010signals,steels2011modeling,young_evolution_2015}.
