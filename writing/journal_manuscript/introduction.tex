...
\rdh{I decided to save the empirical background for each phenomenon for the specific section intros... But maybe it's a good place to put general background about repeated reference games as a paradigm?}
