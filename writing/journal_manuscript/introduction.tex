...
\ndg{consider: The tension between these two basic observations -- stability and flexibility -- has posed a challenging and persistent puzzle for theories of convention.
}
Many influential computational accounts explaining how social conventions emerge in populations \cite<e.g.>{hurford1989biological,barr_establishing_2004,skyrms2010signals,steels2011modeling,young_evolution_2015} do not allow for partner-specific meaning at all.
...
\item[P2:] the influence of \textbf{partner-specificity} as conventions gradually generalize to new partners, and \ndg{this one feels a little hard to grasp... maybe something like the transition of partner-specific conventions to ones that generalize to new partners?}
...
Finally, we close by discussing several broader consequences of the theory, including the continuity of language acquisition \ndg{continuity of language acquisition with later adaptation?}, the domain-generality of discourse processes, and the integration of social and linguistic representations.
...
\paragraph{\textbf{P1}:~Conventions rapidly increase in efficiency} \ndg{these P1-P3 are different than the earlier P1-P3, right? maybe use different enum if labels are needed.. oh, actually after reading more, i think they are intended to be the same items... in which case it would be helpful to make the bolded phrases appear in the above enum.}
...
\paragraph{\textbf{P2}:~Conventions may be partner-specific}
...
\paragraph{\textbf{P3}: Conventions are influenced by communicative context}
