...
This effect arises from Gricean pragmatic reasoning --- if $u_2$ were a better fit for $o_1$, the listener assumes the speaker would have used it instead --- and has been explicitly linked to \emph{mutual exclusivity} in word learning \cite{FrankGoodmanTenenbaum09_Wurwur,smith_learning_2013} \ks{Possibly being a bit too generous to Mike et al here, I am pretty sure e.g. Bloom has the same line of argument in his 2000 book How children learn the meaning of words}.
