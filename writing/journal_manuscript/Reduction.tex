...
We will build up to our explanation of increasing efficiency through a series of simpler simulations.
...
To define the initial lexical prior $P(\phi)$ over the expected meanings of each utterance, we must first say what representation we are using for the agents' lexicon $\mathcal{L}_{\phi}$.
...
Due to this uniform prior, both utterances are equally likely to apply to either object on the first round. 
