...
%\ndg{this... doesn't seem to follow given the max semantics. if the speaker said just $u_1$ the listener would get it right just as often in the first case, still be at chance in the next two, and still low in the last.}
