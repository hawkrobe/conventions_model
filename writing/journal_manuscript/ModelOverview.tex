...
Each possible lexicon can therefore be written as a binary matrix where the rows correspond to utterances, columns correspond to objects, and each row is constrained to sum to 1. 
The function $\mathcal{L}_{\phi}(u,o)$ simply looks up the specified element in the specified matrix.
