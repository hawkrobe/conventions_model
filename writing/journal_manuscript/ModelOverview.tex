...
\end{align}
where $c(u)$ is a function giving the cost of producing $u$, assuming a longer utterances is more costly.
...
\ndg{maybe: "leave the computationally expensive task of parameter fitting to future studies"? to gesture at the reason it isn't easy to fit params...}
