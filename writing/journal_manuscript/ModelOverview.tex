...
As such, we proceed by examining predictions for a regime of parameter values ($\alpha_S, \alpha_L, w_C,\beta$) that make qualitatively informative predictions, and leave parameter-fitting for future work. 
