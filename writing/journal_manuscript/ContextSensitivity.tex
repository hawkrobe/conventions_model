...
\vspace{-1ex}
{\caption{\emph{Results from Simulation 2.1}. (A) Speakers gradually use a larger lexicon size across conditions, and (B) coordinate more quickly in the coarse condition than the fine condition, as observed in the empirical data.} }
\label{fig:sec2model}
\end{center}
\vspace{-3ex}
\end{figure}
