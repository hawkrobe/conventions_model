...
To satisfy the first desideratum, we consider a space of eight objects embedded in a three-level stimulus hierarchy with shape at the top-most level, color/texture at the intermediate levels, and frequency/intensity at the finest levels \cite<see Fig.~\ref{fig:context_design};>{bruner1956study,collins1969retrieval,XuTenenbaum07_WordLearningBayesian}. 
