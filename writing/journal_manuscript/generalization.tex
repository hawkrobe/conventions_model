...
Throughout the following simulations, we set $w_S = 11,~w_C = 7$. 
A grid search over parameter space revealed similar regimes of behavior as in Simulation 1.2 (see Fig.~\ref{fig:partnerspecificity_grid}).
