...
\centering
  ...
  \caption{Speaker efficiency across partners (simulation 2) across a larger parameter regime for complete-pooling, no-pooling, and partial-pooling models. Rows represent agent optimality $\alpha_S = \alpha_L$, columns represent cost weight $w_c$, and colors represent memory discount parameter $\beta$.}
